...
parser.add_argument('-checkpoint', type=str, default='', help='Path to the model checkpoint directory in nnUNet_results', required=True)
parser.add_argument('-data_root', type=str, default='', help='Path to the validation data directory', required=True)
parser.add_argument('-pred_save_dir', type=str, default='', help='Path to the directory where the segmentation results will be saved in npz format')
parser.add_argument('--save_overlay', action='store_true', default=False, help="Whether to save segmentation overlay")
parser.add_argument('-png_save_dir', type=str, default='', help='Path to the directory where the segmentation overlay will be saved in png format')
parser.add_argument('-bbox_shift', type=int, default=10, help='Perturbation shift of bounding box prompt')
parser.add_argument('--grey', action='store_true', default=False, help="Whether the input image is in grey scale")
...
predictor = nnUNetPredictor(
    ...
    perform_everything_on_gpu=False,  # Change this to False
